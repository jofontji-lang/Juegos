...
Pantalla de inicio con tres entradas: **Reto de hoy** (el tablero del día, común para todos, que alimenta la racha), **Campaña** (niveles en orden, con salto automático al siguiente al completarlo) y **Retos anteriores** (calendario mensual).
...
En campaña la dificultad no se elige: sale del número de nivel — del 1 al 20 Fácil, del 21 al 60 Normal, del 61 en adelante Difícil. La modalidad (decimales o fracciones) sí se elige, en Ajustes.
